    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <div className="prose prose-invert mt-8 max-w-none text-foreground/90">
        <p className="text-lg leading-relaxed">
          <strong>KR Street Dance Battles</strong>는 한국에서 열리는 스트릿 댄스 배틀 일정, 결과,
          크루 정보를 한 곳에 모으는 커뮤니티 아카이브입니다.
        </p>
        ...
        <p className="mt-3 text-sm leading-relaxed">
          배틀 정보 제보, 오탈자 수정, 결과 업데이트는 모두 GitHub 이슈나 Pull Request로 받고
          있습니다. 데이터는{" "}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">src/data/battles.json</code>,{" "}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">src/data/crews.json</code>에
          있습니다.
        </p>
